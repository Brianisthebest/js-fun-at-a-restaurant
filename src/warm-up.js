...
var vegetables = ["Onion", "Carrot", "Potato", "Broccoli", "Spinach"];

// Write the code to access the 3rd element of the Array, using bracket
// notation.

var thirdVeg = vegetables[2];

// Create a new variable "fruits" and assign it to an Array of 7
// different fruits.

var fruits = ["Apple", "Banana", "Orange", "Grapes", "Strawberry", "Pineapple", "Watermelon"];
...
groceryStore.location = "Colorado Springs, Colorado";